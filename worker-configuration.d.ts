/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 0e581447a496204eb04498cc50e069b5)
// Runtime types generated with workerd@1.20260405.1 2026-04-08 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "RobotAgent";
	}
	interface Env {
		AI: Ai;
		ASSETS: Fetcher;
		ROBOT_AGENT: DurableObjectNamespace<import("./src/index").RobotAgent>;
		MISSION_WORKFLOW: Workflow<Parameters<import("./src/index").MissionWorkflow['run']>[0]['payload']>;
	}
}
